...
- Active dev branch: `claude/fix-elevator-assignment-error-aUvEz`
- **NEVER push to main without explicit permission**
- After every commit: `git push -u origin claude/fix-elevator-assignment-error-aUvEz`
...
1. Commit and push all changes to `claude/fix-elevator-assignment-error-aUvEz`
