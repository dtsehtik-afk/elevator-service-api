    ...
    with engine.connect() as _conn:
        if engine.dialect.name == "postgresql":
            for _col_sql in [
                ...
                "CREATE INDEX IF NOT EXISTS ix_parts_barcode ON parts (barcode)",
                "ALTER TABLE parts ADD COLUMN IF NOT EXISTS manufacturer_part_number VARCHAR(100)",
                "ALTER TABLE parts ADD COLUMN IF NOT EXISTS weight_kg DOUBLE PRECISION",
                "ALTER TABLE parts ADD COLUMN IF NOT EXISTS dimensions VARCHAR(50)",
                "ALTER TABLE parts ADD COLUMN IF NOT EXISTS storage_slot VARCHAR(50)",
                "ALTER TABLE parts ADD COLUMN IF NOT EXISTS lead_time_days INTEGER",
                "ALTER TABLE parts ADD COLUMN IF NOT EXISTS tax_exempt BOOLEAN NOT NULL DEFAULT FALSE",
                ...
                "ALTER TABLE projects ADD COLUMN IF NOT EXISTS elevator_count INTEGER",
                "ALTER TABLE projects ADD COLUMN IF NOT EXISTS manufacturer VARCHAR(100)",
                ...
                # Project installation milestones
                "ALTER TABLE projects ADD COLUMN IF NOT EXISTS milestone_elevator_arrived BOOLEAN NOT NULL DEFAULT FALSE",
                "ALTER TABLE projects ADD COLUMN IF NOT EXISTS milestone_installation_started BOOLEAN NOT NULL DEFAULT FALSE",
                "ALTER TABLE projects ADD COLUMN IF NOT EXISTS milestone_phase_a BOOLEAN NOT NULL DEFAULT FALSE",
                "ALTER TABLE projects ADD COLUMN IF NOT EXISTS milestone_phase_b BOOLEAN NOT NULL DEFAULT FALSE",
                "ALTER TABLE projects ADD COLUMN IF NOT EXISTS milestone_phase_c BOOLEAN NOT NULL DEFAULT FALSE",
                "ALTER TABLE projects ADD COLUMN IF NOT EXISTS milestone_initial_inspection BOOLEAN NOT NULL DEFAULT FALSE",
                "ALTER TABLE projects ADD COLUMN IF NOT EXISTS milestone_consultant_approved BOOLEAN NOT NULL DEFAULT FALSE",
                ...
                # ── Service call fields added later (missing on older DBs) ────────
                "ALTER TABLE service_calls ADD COLUMN IF NOT EXISTS monitoring_notes TEXT",
                "ALTER TABLE service_calls ADD COLUMN IF NOT EXISTS monitoring_since TIMESTAMPTZ",
                "ALTER TABLE service_calls ADD COLUMN IF NOT EXISTS is_chargeable BOOLEAN NOT NULL DEFAULT FALSE",
                "ALTER TABLE service_calls ADD COLUMN IF NOT EXISTS contract_id UUID REFERENCES contracts(id) ON DELETE SET NULL",
                "ALTER TABLE service_calls ADD COLUMN IF NOT EXISTS invoice_id UUID REFERENCES invoices(id) ON DELETE SET NULL",
                "ALTER TABLE service_calls ADD COLUMN IF NOT EXISTS quote_id UUID REFERENCES quotes(id) ON DELETE SET NULL",
                "ALTER TABLE service_calls ADD COLUMN IF NOT EXISTS customer_po_number VARCHAR(50)",
                "ALTER TABLE service_calls ADD COLUMN IF NOT EXISTS technician_arrival_time TIMESTAMPTZ",
                "ALTER TABLE service_calls ADD COLUMN IF NOT EXISTS technician_departure_time TIMESTAMPTZ",
                "ALTER TABLE service_calls ADD COLUMN IF NOT EXISTS travel_time_minutes INTEGER",
                "ALTER TABLE service_calls ADD COLUMN IF NOT EXISTS work_time_minutes INTEGER",
                "ALTER TABLE service_calls ADD COLUMN IF NOT EXISTS requires_time_report BOOLEAN NOT NULL DEFAULT FALSE",
                "ALTER TABLE service_calls ADD COLUMN IF NOT EXISTS malfunction_code VARCHAR(50)",
                "ALTER TABLE service_calls ADD COLUMN IF NOT EXISTS repair_code VARCHAR(50)",
                "ALTER TABLE service_calls ADD COLUMN IF NOT EXISTS contact_name_on_site VARCHAR(100)",
                "ALTER TABLE service_calls ADD COLUMN IF NOT EXISTS customer_signature_url TEXT",
                "ALTER TABLE service_calls ADD COLUMN IF NOT EXISTS is_recurring BOOLEAN NOT NULL DEFAULT FALSE",
                "ALTER TABLE service_calls ADD COLUMN IF NOT EXISTS quote_needed BOOLEAN NOT NULL DEFAULT FALSE",
                "ALTER TABLE service_calls ADD COLUMN IF NOT EXISTS assigned_at TIMESTAMPTZ",
                "ALTER TABLE service_calls ADD COLUMN IF NOT EXISTS resolved_at TIMESTAMPTZ",
                "CREATE INDEX IF NOT EXISTS ix_service_calls_contract_id ON service_calls (contract_id)",
                # ── Consultants ──────────────────────────────────────────────
