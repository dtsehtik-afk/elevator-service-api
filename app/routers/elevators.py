...
def list_elevators(
    ...
    search: Optional[str] = Query(None, description="Free-text search across address, city, building name"),
    ...
    return elevator_service.list_elevators(db, city, status, min_risk, max_risk, skip, limit, search=search)
