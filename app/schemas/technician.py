...
class TechnicianCreate(BaseModel):
    ...
    role: str = Field("TECHNICIAN", pattern="^(ADMIN|TECHNICIAN|DISPATCHER|CEO|VP|SERVICE_MANAGER|ACCOUNTANT|SECRETARY|SALES|INVENTORY_MANAGER|SALES_MANAGER)$")
...
class TechnicianUpdate(BaseModel):
    ...
    phone: Optional[str] = None
    whatsapp_number: Optional[str] = None
    role: Optional[str] = Field(None, pattern="^(ADMIN|TECHNICIAN|DISPATCHER|CEO|VP|SERVICE_MANAGER|ACCOUNTANT|SECRETARY|SALES|INVENTORY_MANAGER|SALES_MANAGER)$")
